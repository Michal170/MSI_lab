...
for fold_id, (train, test) in enumerate(rskf.split(X,y)):
    for prepoc_id, prepoc in enumerate(preprocs):
        clf = clone(clf)
        ...
        for metric_id, metric in enumerate(metrics):
            scores[prepoc_id, fold_id, metric_id] = metrics[metric](y[test], y_pred)
